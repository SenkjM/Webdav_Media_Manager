...
**相关完整文档**：[08 同步与备份](08-SYNC-AND-BACKUP.md)（交互约定已写，逐条语义未写）、[03 音乐库](03-MUSIC-LIBRARY.md)、[04 下载队列](04-DOWNLOAD-QUEUE.md)（对账）。

这些结论已经落地在代码里，但只在这里记着；等 08 收口时按完整文档的写法搬过去。
...
**相关完整文档**：[02 网络库](02-NETWORK-LIBRARY.md)（§2、§8）、[04 下载队列](04-DOWNLOAD-QUEUE.md)。
