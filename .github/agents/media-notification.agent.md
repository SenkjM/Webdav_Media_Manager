...
- Read the "权限与媒体通知" and "技术要点" sections of [README.md](README.md) for the intended design, then cross-check:
  ...
  - [android/app/src/main/kotlin/com/webdav/webdav_music_player/MainActivity.kt](android/app/src/main/kotlin/com/webdav/webdav_music_player/MainActivity.kt) — whether it extends `AudioServiceActivity` (or `FlutterFragmentActivity` per current `audio_service` versions).
